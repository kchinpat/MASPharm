...
import os
from lock_lights_serial_input import open_drawer, emUnlock, rgbOn, setup_uart, send_byte, Data
import json
from serial import *
app = Flask(__name__)
uart = setup_uart()
...
@app.route("/unlock_cabinet_lock", methods=["POST"])
@require_api_key
def api_unlock():
    #TODO:
    # emUnlock(uart)
